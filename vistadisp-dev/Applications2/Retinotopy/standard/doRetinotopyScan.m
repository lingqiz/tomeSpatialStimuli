...
try
    ...
    for n = 1:params.repetitions,
        ...
        % wait for go signal
        onlyWaitKb = false;
        promptString = 'SCAN STARTING SOON, HOLD STILL!!!';
        pressKey2Begin(params.display, onlyWaitKb, [], promptString, params.triggerKey);
        ...
        if params.savestimparams,
            filename = fullfile(['params-', datestr(clock,'yyyymmdd-HHMM-SS'), '.mat']);
            save(fullfile(params.savePath, params.runName, filename));
